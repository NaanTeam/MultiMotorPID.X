...
{    
    ...
    ADXL362_XAcceleration = G_per_LSB * (float)x_16b;
    ADXL362_YAcceleration = G_per_LSB * (float)y_16b;
    ADXL362_ZAcceleration = G_per_LSB * (float)z_16b;
    ADXL362_Temperature = C_per_LSB * (float)temp_16b;
